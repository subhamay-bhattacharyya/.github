...
<table role="table" aria-label="Project status table" style="width:100%; border-collapse:collapse;">
  <thead>
    <tr>
      ...
      <th style="border:1px solid #e5e7eb; padding:8px; background:#f8fafc;"><img src="templates/resources/git-branch.svg"></th>
      <th style="border:1px solid #e5e7eb; padding:8px; background:#f8fafc;"><img src="templates/resources/git-branch.svg" alt="Git Open branches"></th>
      <th style="border:1px solid #e5e7eb; padding:8px; background:#f8fafc;"><img src="templates/resources/git-branch.svg" alt="Git Open branches"></th>
      <th style="border:1px solid #e5e7eb; padding:8px; background:#f8fafc;"><img src="templates/resources/git-branch.svg" alt="Git Open branches"></th>
    </tr>
  </thead>
